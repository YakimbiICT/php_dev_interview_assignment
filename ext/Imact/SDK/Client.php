...
class Client
{
    ...
    public function __construct()
    {
        ...
        $this->calls = array("random" => HTTP_METH_GET, "add" => HTTP_METH_POST,
                "edit" => HTTP_METH_POST, "read" => HTTP_METH_GET,
    ...
    private function edit(&$data)
    {
        ...
        $this->valid = array("id" => 'required', "title" => 'either',
                "description" => 'either');
    ...
    private function isValid(&$data)
    {
        ...
        foreach ($this->valid as $key => $value) {
            if (!isset($data[$key]) && $value == "required")
                return false;
            if (!isset($data[$key]) && $value == "either")
                $either++;
            if (isset($data[$key]))

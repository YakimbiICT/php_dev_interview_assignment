...
abstract class Imact_Model_Image_Base extends Imact_Model_Abstract  {
/*
	public $data = array(
	...
	protected $dMap = array(    "localKey" => "id",
								"type"=> "type",
							    "width" => "width",
								"height" => "height",
								"size" => "size",
	...
	public function delete($id){
		...
		if(!empty($existing)){
			$params = array( "command" => "delete", "where" => array('id' => $id));
			$sql =$this->query($params);
